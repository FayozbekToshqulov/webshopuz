    ...
    <div className='bg-white'>
          ...
          <div className="lg:w-4/6 mx-auto">
            <div className="flex flex-col sm:flex-row mt-10">
              <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div className="w-28 h-28 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
                  <img src={Logo1} alt="" />
                </div>
                <div className="flex flex-col items-center text-center justify-center">
                  <h2 className="font-medium title-font mt-4 text-gray-900 text-lg">Web Shop</h2>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Web Shop online do'konidan qanday buyurtma beriladi ?</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base mb-[-2%]">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven't heard of them man bun deep jianbing selfies heirloom.</p>
          </div>
          <div className="flex flex-wrap -mx-1 -mb-10 text-center">
            <div className="sm:w-1/2 mb-10 px-10">
              <div className="rounded-lg h-[300px] overflow-hidden">
                <iframe className='object-cover object-center h-[100%] w-full' src="https://www.youtube.com/embed/3BmNX5zoBAo?si=nPtoYnB1pLE7DD-E" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
              </div>
              <h2 className="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">Buy YouTube Videos</h2>
              <p className="leading-relaxed text-base w-[80%] m-auto">Williamsburg occupy sustainable snackwave gochujang. Pinterest cornhole brunch, slow-carb neutra irony.</p>
            </div>
            <div className="sm:w-1/2 mb-10 px-10">
              <div className="rounded-lg h-[300px] overflow-hidden">
                <iframe className='object-cover object-center h-[100%] w-full' width="" height="" src="https://www.youtube.com/embed/ypR-GjA-mYs?si=uA189FTCK0Im-MbQ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
              </div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-0 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="max-sm:px-[30px] sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Those who bought things from the Web Shop online store!</h1>
            <p className="max-sm:m-auto w-[80%] lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table.</p>
          </div>
                  ...
                  <div className="lg:w-1/4 md:w-1/2 p-4">
                    <div className="max-sm:w-[320px] block relative h-[350px] w-[350px] rounded overflow-hidden">
                      ...
                      <div className="h-[350px] w-[350px] px-8 py-5 relative z-10 border-[1px] border-blue-500 rounded-xl bg-white opacity-0 hover:opacity-100  active:opacity-100">
                        <h2 className="tracking-widest text-sm title-font font-medium text-indigo-500 mt-[5%] mb-[15%]">webshop.uz</h2>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className=" py-8 px-4 mx-auto max-w-[88%] text-center lg:py-16 lg:px-6">
          ...
          <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2">
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src={CEO} alt="Jese Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Islom Qodirov</a>
              </h3>
              <p>Front-end - Junior & Marketing</p>
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src={BOB} alt="Bonnie Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Bobur</a>
              </h3>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <h1 className="text-3xl font-medium title-font text-gray-900 mb-12 text-center">What do our customers think about us!</h1>
          <div className="flex flex-wrap -m-4 px-[7%]">
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-100 p-8 rounded">
                ...
                <a className="inline-flex items-center">
                  <img alt="testimonial" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
            ...
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-100 p-8 rounded">
                ...
                <p className="leading-relaxed mb-6">Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra before they sold out fixie 90's microdosing. Tacos pinterest fanny pack venmo, post-ironic heirloom try-hard pabst authentic iceland.</p>
                <a className="inline-flex items-center">
                  <img alt="testimonial" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/joseph-mcfall.png" className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                  <span className="flex-grow flex flex-col pl-4">
